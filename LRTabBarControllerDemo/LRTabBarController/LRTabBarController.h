...
@protocol LRTabBarControllerDelegate <NSObject>
...
@interface LRTabBarController : UIViewController <LRTabBarDelegate, UINavigationControllerDelegate>

@property (nonatomic, weak) id<LRTabBarControllerDelegate> delegate;
